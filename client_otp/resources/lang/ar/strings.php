...
<p>- Anthony Rappa</p>',
    ...
    'frontend' => [
        ...
        'tests' => [
            ...
            'using_access_helper' => [
                'array_permissions'     => 'Using Access Helper with Array of Permission Names or ID\'s where the billing does have to possess all.',
                'array_permissions_not' => 'Using Access Helper with Array of Permission Names or ID\'s where the billing does not have to possess all.',
                'array_roles'           => 'Using Access Helper with Array of Role Names or ID\'s where the billing does have to possess all.',
                'array_roles_not'       => 'Using Access Helper with Array of Role Names or ID\'s where the billing does not have to possess all.',
            ...
            'view_console_it_works'          => 'View console, you should see \'it works!\' which is coming from FrontendController@index.blade.php',
