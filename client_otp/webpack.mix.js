...
mix.sass('resources/assets/sass/frontend/app.scss', 'public/css/frontend.css')
    ...
    .styles([
        ...
        'public/assets/slick/slick.css',
        'public/slick/slick-theme.css',
        'public/assets/popup/popup-style.css',
        'public/assets/css/main-style.css'
    ], 'public/css/app.css')
    .js([
        "public/js/jquery.min.js",
        "public/js/bootstrap.min.js",
        "public/assets/slick/slick.min.js",
        "public/assets/popup/popup.js",
        "public/js/analytic.js",
        "public/js/main.js?v=45353224"
    ], 'public/js/app.js')
    .js([
